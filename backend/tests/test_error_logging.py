...
server records method + path + reason so failures are diagnosable
without asking the user what they saw.
"""
...
def test_validation_error_logs_method_and_path(client, caplog):
